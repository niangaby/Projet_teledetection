...
out_folder = '/home/onyxia/work/results/data/classif'  # Modifier le dossier de sortie
os.makedirs(out_folder, exist_ok=True)  # Crée le dossier de sortie s'il n'existe pas
out_classif = os.path.join(out_folder, 'carte_essences_echelle_pixel.tif')  # Renommer l'image de classification
out_matrix = os.path.join(out_folder, '_matrice{}.png'.format(suffix))
out_qualite = os.path.join(out_folder, '_qualites{}.png'.format(suffix))
